 ...
 * @generated
 */
public class TagItemProvider extends ModelPartItemProvider {
	/**
	...
	protected void addAppliesToPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Tag_AppliesTo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Tag_AppliesTo_feature", "_UI_Tag_type"),
				 conmlPackage.Literals.TAG__APPLIES_TO,
				 true,
				 false,
				 true,
				 null,
