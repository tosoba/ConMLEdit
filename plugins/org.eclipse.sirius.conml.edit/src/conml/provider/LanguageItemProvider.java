...
/**
 * This is the item provider adapter for a {@link conml.Language} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LanguageItemProvider extends ModelPartItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 conmlPackage.Literals.LANGUAGE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Language_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Language_description_feature", "_UI_Language_type"),
				 conmlPackage.Literals.LANGUAGE__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addModelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Language_Model_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Language_Model_feature", "_UI_Language_type"),
				 conmlPackage.Literals.LANGUAGE__MODEL,
				 true,
				 false,
				 true,
				 null,
