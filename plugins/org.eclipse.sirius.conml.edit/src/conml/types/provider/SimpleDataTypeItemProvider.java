...
/**
 * This is the item provider adapter for a {@link conml.types.SimpleDataType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SimpleDataTypeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
  ...
  /**
	...
	protected void addBasePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SimpleDataType_base_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SimpleDataType_base_feature", "_UI_SimpleDataType_type"),
				 TypesPackage.Literals.SIMPLE_DATA_TYPE__BASE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((SimpleDataType)object).getName();
