...
/**
 * This is the item provider adapter for a {@link conml.instances.TimeValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TimeValueItemProvider extends ValueItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TimeValue_content_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TimeValue_content_feature", "_UI_TimeValue_type"),
				 InstancesPackage.Literals.TIME_VALUE__CONTENT,
				 true,
				 false,
				 false,
  ...
  /**
	...
	public String getText(Object object) {
		DegreeOfCertainty labelValue = ((TimeValue)object).getCertainty();
