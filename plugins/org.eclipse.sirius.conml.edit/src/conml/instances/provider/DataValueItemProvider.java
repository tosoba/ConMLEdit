...
/**
 * This is the item provider adapter for a {@link conml.instances.DataValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataValueItemProvider extends ValueItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataValue_content_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataValue_content_feature", "_UI_DataValue_type"),
				 InstancesPackage.Literals.DATA_VALUE__CONTENT,
				 true,
				 false,
				 false,
  ...
  /**
	...
	public String getText(Object object) {
		DegreeOfCertainty labelValue = ((DataValue)object).getCertainty();
