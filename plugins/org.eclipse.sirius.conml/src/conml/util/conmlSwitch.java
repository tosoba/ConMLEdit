 ...
 * @generated
 */
public class conmlSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case conmlPackage.MODEL_PART: {
				ModelPart modelPart = (ModelPart)theEObject;
				T result = caseModelPart(modelPart);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case conmlPackage.MODEL_ELEMENT: {
				ModelElement modelElement = (ModelElement)theEObject;
				T result = caseModelElement(modelElement);
				if (result == null) result = caseModelPart(modelElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case conmlPackage.TAG: {
			...
			case conmlPackage.META_INFORMATION: {
			...
			case conmlPackage.COMMENTABLE_ELEMENT: {
