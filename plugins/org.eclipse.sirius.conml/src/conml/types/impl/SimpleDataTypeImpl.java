...
public class SimpleDataTypeImpl extends DataTypeImpl implements SimpleDataType {
	 ...
	 * @ordered
	 */
	protected static final BaseDataType BASE_EDEFAULT = BaseDataType.BOOLEAN;
	 ...
	 * @ordered
	 */
	protected BaseDataType base = BASE_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return TypesPackage.Literals.SIMPLE_DATA_TYPE;
	}
	 ...
	 */
	@Override
	public void setBase(BaseDataType newBase) {
		BaseDataType oldBase = base;
		base = newBase == null ? BASE_EDEFAULT : newBase;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.SIMPLE_DATA_TYPE__BASE, oldBase, base));
	}
