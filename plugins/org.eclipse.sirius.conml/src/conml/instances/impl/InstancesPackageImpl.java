...
public class InstancesPackageImpl extends EPackageImpl implements InstancesPackage {
  ...
  /**
	 ...
	 */
	@Override
	public EReference getObject_MetaInfo() {
  ...
  /**
	...
	public void createPackageContents() {
		...
		createEReference(objectEClass, OBJECT__META_INFO);
	...
	public void initializePackageContents() {
		...
		initEReference(getObject_MetaInfo(), theconmlPackage.getMetaInformation(), theconmlPackage.getMetaInformation_Object(), "MetaInfo", null, 0, 1, conml.instances.Object.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
