...
/**
 * This is the item provider adapter for a {@link conml.types.DataType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataType_AppliesTo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataType_AppliesTo_feature", "_UI_DataType_type"),
				 TypesPackage.Literals.DATA_TYPE__APPLIES_TO,
				 true,
				 false,
				 true,
				 null,
