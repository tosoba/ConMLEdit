		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TypeModelElement_IsAssignedTo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TypeModelElement_IsAssignedTo_feature", "_UI_TypeModelElement_type"),
				 TypesPackage.Literals.TYPE_MODEL_ELEMENT__IS_ASSIGNED_TO,
				 true,
				 false,
				 true,
				 null,
